...
const RESOURCES: Resource[] = [
  ...
  {
    id: "11",
    title: "React Native: Mobil Ilovalar Yaratish",
    ...
    free: false,
    downloads: 2900,
    desc: "React Native yordamida iOS va Android ilovalar yaratish — sozlashdan App Store/Play Store'ga chiqarishgacha.",
    accent: "violet",
  },
  {
    id: "12",
    title: "O'zbekistonda E-Commerce: 2024 Bozor Tahlili",
    author: "Uzum Market Research",
    type: "report",
    category: "Startap",
    year: 2024,
    pages: 52,
    ...
    free: true,
    downloads: 1750,
    desc: "O'zbekiston onlayn savdo bozorining tendentsiyalari, yetakchi platformalar va xaridorlar xulq-atvori.",
    accent: "emerald",
  },
  {
    id: "13",
    title: "Blockchain va Web3 Texnologiyalari",
    author: "CryptoUZ Foundation",
    type: "guide",
    category: "AI/ML",
    year: 2024,
    pages: 88,
    ...
    free: true,
    downloads: 870,
    desc: "Blockchain asoslaridan DeFi va smart contract yaratishgacha — amaliy misollar bilan.",
    accent: "cyan",
  },
  {
    id: "14",
    title: "Namangan Viloyati IT Infratuzilmasi: 2024",
    author: "Namangan Viloyat Hokimligi",
    type: "report",
    ...
    free: true,
    downloads: 640,
    desc: "Namangan viloyatining raqamli transformatsiya rejasi, fiber optik tarmoq va IT Park rivojlanish holati.",
    accent: "violet",
  },
  {
    id: "15",
    title: "Flutter bilan Cross-Platform Dasturlash",
    author: "DartLab UZ",
    type: "book",
    category: "Dasturlash",
    year: 2023,
    ...
    free: false,
    downloads: 3800,
    desc: "Flutterda bitta kod bazasidan iOS, Android va Web ilovalar yaratish — state management va Firebase integratsiyasi.",
    accent: "emerald",
  },
];
