      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 lg:grid-cols-5">
          <div className="lg:col-span-1">
            ...
            <div className="mt-5 space-y-2 text-[12px] text-muted">
              <p className="flex items-start gap-2">
                <span className="mt-0.5 shrink-0 text-accent">📍</span>
                Istiqlol ko&apos;chasi 15, Uychi tumani, Namangan
              </p>
              <p className="flex items-center gap-2">
                <span className="shrink-0 text-accent">📞</span>
                <a href="tel:+998792240000" className="transition-colors hover:text-accent">+998 79 224 00 00</a>
              </p>
              <p className="flex items-center gap-2">
                <span className="shrink-0 text-accent">✉</span>
                <a href="mailto:info@uychi.uz" className="transition-colors hover:text-accent">info@uychi.uz</a>
              </p>
              <p className="flex items-center gap-2">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a href={SOCIAL.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-card text-muted transition-all hover:border-violet-400/30 hover:text-violet-400">
              ...
              <a href={SOCIAL.telegram} target="_blank" rel="noopener noreferrer" aria-label="Telegram"
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-card text-muted transition-all hover:border-accent/30 hover:text-accent">
              ...
              <a href={SOCIAL.whatsapp} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-card text-muted transition-all hover:border-emerald-400/30 hover:text-emerald-400">
          ...
          {Object.entries(FOOTER_LINKS).map(([section, links]) => (
            <div key={section}>
              <h4 className="mb-4 text-[11px] font-bold uppercase tracking-[0.15em] text-muted">{section}</h4>
              <ul className="space-y-2.5">
                {links.map((l) => (
                  <li key={l.href}>
                    <Link href={l.href} className="text-[13px] text-muted transition-colors hover:text-accent">
                      {l.label}
                    </Link>
                  </li>
                ))}
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 text-[12px] text-muted-foreground sm:flex-row">
