...
const accentMap: Record<string, {
  ...
  cyan: {
    ...
    tag: "bg-accent/8 text-accent/80 border-accent/12",
    metricText: "text-accent",
    learnMore: "text-accent hover:text-accent-dark",
  },
  accent: {
    border: "border-accent/20 hover:border-accent/45",
    badge: "bg-accent/10 text-accent border-accent/20",
      ...
      <div className="relative z-10 flex flex-col gap-4 h-full">
        ...
        <div className="flex flex-1 flex-col gap-3 text-[13px]">
          <div>
            ...
            <p className="mt-1.5 leading-relaxed text-muted">{startup.problem}</p>
          </div>
          <div>
            <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-muted-foreground">Yechim</span>
            <p className="mt-1.5 leading-relaxed text-muted">{startup.solution}</p>
          </div>
        </div>
    ...
    <section id="startups" className="relative border-t border-border-subtle bg-background px-6 py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          ...
          <h2 className="mt-3 text-[clamp(1.8rem,4vw,2.8rem)] font-bold leading-tight tracking-tight text-foreground">
        ...
        >
          <Link href="/apply/startup" className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-6 py-2.5 text-[13px] font-semibold text-muted transition-all hover:border-border hover:text-foreground">
